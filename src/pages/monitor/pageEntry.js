...
if(window['Vue']){
  ...
  app.use(window.TToggle.default, {language: tLocale})
  
  app.use(window.TDateTime.default, {language: tLocale})
  
  app.use(window.TCheckboxGroup.default, {language: tLocale})
