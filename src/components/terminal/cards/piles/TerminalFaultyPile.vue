                ...
                <div class="terminal-pile-card__top-row">
                    ...
                    <div class="terminal-pile-card__main">
                        <div class="terminal-pile-card__status-row">
                            <div v-if="showFaultReason" class="terminal-pile-card__alert">
                                <div class="terminal-pile-card__alert-inner">
                                    <div class="terminal-pile-card__alert-icon-wrap">
                                        <t-icon class="terminal-pile-card__alert-icon" size="12px" color="#FFFFFF"
                                            name="fas dx-icon icon-t-exclamation">
                                        </t-icon>
                                    </div>
                                    <span class="terminal-pile-card__alert-text">{{ LocalVars.pile.FaultReason }}</span>
                                </div>
                            </div>
                        </div>
...
const {
    ...
    orderCardInfo,
    orderCardTitle,
    orderCardColumns: orderCardColumn,
    totalPriceText: TotalPriceStr,
    orderCardTableData,
    showOrderCard,
    toOrderPage
